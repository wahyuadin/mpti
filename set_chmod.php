...
?>
	...
	?>
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  <label for="menu2" class="col-sm-3 control-label">Menu Pelanggan</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu3" class="col-sm-3 control-label">Menu Satuan</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu4" class="col-sm-3 control-label">Menu Jenis</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Menu Transaksi</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="menu6" class="col-sm-3 control-label">Menu Operasional</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="menu7" class="col-sm-3 control-label">Menu Order</label>
                  <div class="col-sm-9">
				...
				<div class="form-group">
                  <label for="menu8" class="col-sm-3 control-label">Menu Laporan</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                          <label for="menu9" class="col-sm-3 control-label">Menu Pengaturan</label>
                          <div class="col-sm-9">
