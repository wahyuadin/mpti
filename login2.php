...
<body class="hold-transition login-page">
  ...
  <div class="login-logo">
    <a href=""><font color="white"><b>LauraSys</b>App</a></font>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="op.php" method="post">
      ...
      <h5 style="text-align:center;color:red;">Username atau Password salah, Ulangi!</h5><hr/>
      <div class="row">
        <!-- /.col -->
    ...
    <!-- /.social-auth-links -->
  <br>
    <p class="login-box-msg">Copyright © 2020 Aplikasi Laundry <br/>Laundry Management System</p>
