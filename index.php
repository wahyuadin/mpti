...
<?php if($_SESSION['jabatan'] !='admin'){}else{ ?>
      ...
      <form align="center" method="post" action="order_data.php">  <button style="background-color: Transparent;border: none;" type="submit" name="search" value="Diterima" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></button>    </form>
                           </div>
                       </div>
                       ...
                       <div class="col-lg-3 col-xs-6">
                         ...
                         <div class="small-box bg-green">
                             ...
                             <div class="icon">
                               ...
                               <form align="center" method="post" action="order_data.php">  <button style="background-color: Transparent;border: none;" type="submit" name="search" value="proses" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></button>    </form>
                         </div>
                     </div>
                     ...
                     <div class="col-lg-3 col-xs-6">
                       ...
                       <div class="small-box bg-yellow">
                           ...
                           <div class="icon">
                            ...
                            <form align="center" method="post" action="order_data.php">  <button style="background-color: Transparent;border: none;" type="submit" name="search" value="<?php echo $besok; ?>" class="small-box-footer">info Lengkap <i class="fa fa-arrow-circle-right"></i></button>    </form>
                       </div>
                   </div>
                   ...
                   <div class="col-lg-3 col-xs-6">
                     ...
                     <div class="small-box bg-red">
                         ...
                         <div class="icon">
                           ...
                           <form align="center" method="post" action="order_data.php">  <button style="background-color: Transparent;border: none;" type="submit" name="search" value="<?php echo $today; ?>" class="small-box-footer">info Lengkap <i class="fa fa-arrow-circle-right"></i></button>    </form>
                     </div>
                 </div>
